...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // 赋值之前
        System.out.println("赋值之前：" + fieldUpdater.get(person));
        // compareAndSet(T obj, int expect, int update)方法的作用是如果当value==expect，那么就将update赋给value，否则什么也不做。
        boolean successed = fieldUpdater.compareAndSet(person, 0, 18);
        // 赋值是否成功
        System.out.println("赋值是否成功：" + successed);
        // 输出结果
        System.out.println("赋值之后：" + fieldUpdater.get(person));
    }
}
