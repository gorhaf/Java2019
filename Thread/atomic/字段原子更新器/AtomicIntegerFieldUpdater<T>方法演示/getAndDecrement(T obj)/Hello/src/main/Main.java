...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        int result = fieldUpdater.getAndDecrement(person);
        // 输出结果
        System.out.println("getAndDecrement(T obj)方法执行结果：" + result);
        // decrementAndGet(T obj)方法的作用是递减指定对象的字段的值，返回递减后的值。
        result = fieldUpdater.decrementAndGet(person);
        // 输出结果
        System.out.println("decrementAndGet(T obj)方法执行结果：" + result);
    }
}
