...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        int result = fieldUpdater.getAndIncrement(person);
        // 输出结果
        System.out.println("getAndIncrement(T obj)方法执行结果：" + result);
        // incrementAndGet(T obj)方法的作用是递增指定对象的字段的值，返回递增后的值。
        result = fieldUpdater.incrementAndGet(person);
        // 输出结果
        System.out.println("incrementAndGet(T obj)方法执行结果：" + result);
    }
}
